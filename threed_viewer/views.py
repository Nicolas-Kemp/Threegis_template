...
class ThreeViewer(View):
    ...
    gdf_populated_places = gpd.read_file(r'static/gpkg/template.gpkg', layer='osm_poi_hermanus')
    ...
    def get(self, request):
        ...
        dict_osm_poi = three_func.import_spatial_layer(self.gdf_populated_places, "osm_poi", height_map=self.tiff_hermanus).object_dict()
